...
/* For net_sprint_ll_addr_buf(), used to format FTM peer MAC addresses. The
 * header has inline helpers that log, so it must follow the module registration.
 */
